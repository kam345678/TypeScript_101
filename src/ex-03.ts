...
addMember({ nameTH: "ก่ำ ลุคำ", nameEN: "kam", heightCm: 168, age: 22 }); 

 

// ค้นหาชื่อ Joe 

const memberJoe = findByName("kam"); 

if (memberJoe) { 

    console.log(`พบสมาชิกชื่อ kam: ${memberJoe.nameTH} (${memberJoe.nameEN})`); 

} else { 

    console.log("ไม่พบสมาชิกชื่อ kam"); 
